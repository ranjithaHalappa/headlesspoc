 ...
 */
package com.vationheadlesspoc.core.models;
...
import com.vationheadlesspoc.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "vationheadlesspoc/components/helloworld");
